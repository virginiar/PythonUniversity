...
class App(tk.Tk):
    ...
    def cargar_tabla(self):
        ...
        self.tabla.heading('Membresia', text='Membresía', anchor="w")

        # Definir las columnas
        self.tabla.column('Id', anchor="center", width=50)
        self.tabla.column('Nombre', anchor="w", width=100)
        self.tabla.column('Apellido', anchor="w", width=100)
        self.tabla.column('Membresia', anchor="w", width=100)
        ...
        scrollbar = ttk.Scrollbar(self.frame_tabla, orient="vertical",
