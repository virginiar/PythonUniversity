...
tabla.heading('Edad', text='Edad', anchor="w")
...
# datos = ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32)) + ((1, 'Alejandra', 25), (2, 'Matías', 32))
# datos = datos * 20
for persona in datos:
    tabla.insert(parent='', index="end", values=persona)
...
def mostrar_registro_seleccionado(event):
    print('Ejecutando el método mostrar_registro_seleccionado')
